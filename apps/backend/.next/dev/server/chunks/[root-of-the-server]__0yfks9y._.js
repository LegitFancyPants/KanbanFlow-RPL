...
"[project]/apps/backend/src/app/api/members/project/[projectid]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    try {
        ...
        if (!id_member) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "id_member harus diisi"
            }, {
                status: 400
            });
        }
        const check = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT status FROM members WHERE id_member = $1 AND id_project = $2`, [
            id_member,
            projectid
        ]);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`DELETE FROM members WHERE id_member = $1 AND id_project = $2`, [
            id_member,
            projectid
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0yfks9y._.js.map