...
"[project]/apps/backend/src/app/api/tasks/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT t.*, COALESCE(u.username, 'Unknown') AS username
       ...
       WHERE t.id_task = $1`, [
        ...
        // Viewer+ boleh lihat
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canView"])(userId, task.id_project)) {
...
async function PUT(req, { params }) {
    try {
        ...
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canEdit"])(userId, taskRes.rows[0].id_project)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forbidden"])("Hanya Owner atau Member yang dapat mengubah tugas");
        }
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`UPDATE tasks
...
async function DELETE(req, { params }) {
    try {
        ...
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canEdit"])(userId, taskRes.rows[0].id_project)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forbidden"])("Hanya Owner atau Member yang dapat menghapus tugas");
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("DELETE FROM tasks WHERE id_task = $1", [
            Number(id)
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10bxs6g._.js.map