...
"[project]/apps/backend/src/app/api/projects/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["canView"])(userId, id)) {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT * FROM projects WHERE id_project = $1`, [
            Number(id)
        ]);
...
async function PUT(req, { params }) {
    try {
        ...
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isOwner"])(userId, id)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forbidden"])("Hanya Owner yang dapat mengubah proyek");
        }
        const body = await req.json();
        const { name, description } = body;
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`UPDATE projects
...
async function DELETE(req, { params }) {
    try {
        ...
        if (!await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isOwner"])(userId, id)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$roleGuard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["forbidden"])("Hanya Owner yang dapat menghapus proyek");
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`DELETE FROM projects WHERE id_project = $1`, [
            Number(id)
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0__~ynt._.js.map