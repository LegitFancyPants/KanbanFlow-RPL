  ...
  return (
    <div className="bg-white text-slate-800 font-sans min-h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="relative z-10 flex-grow flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white rounded-[2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 sm:p-10 flex flex-col items-center">
          ...
          <form className="w-full space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-start text-sm text-slate-700 font-semibold">
